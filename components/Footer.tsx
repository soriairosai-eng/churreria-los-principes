...
const Footer: React.FC = () => {
  return (
    <footer id="contacto" className="bg-brand-dark text-white py-20 border-t border-brand-gold/20">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1 lg:col-span-1">
          <h3 className="text-2xl font-serif text-brand-gold mb-6 tracking-tighter">LOS PRÍNCIPES</h3>
          ...
          <div className="flex space-x-4">
            <a href={BUSINESS_INFO.instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:border-brand-gold hover:text-brand-gold transition-all">
            ...
            <a href={BUSINESS_INFO.facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:border-brand-gold hover:text-brand-gold transition-all">
        ...
        <div>
          <h4 className="text-sm font-bold uppercase tracking-widest text-brand-gold mb-6">Ubicación</h4>
          ...
          <a
            ...
            className="text-xs text-brand-gold underline tracking-widest hover:text-white transition-colors"
          >
            VER EN GOOGLE MAPS
          </a>
        </div>
        ...
        <div>
          <h4 className="text-sm font-bold uppercase tracking-widest text-brand-gold mb-6">Contacto</h4>
          ...
          <h4 className="text-sm font-bold uppercase tracking-widest text-brand-gold mb-2">Horario</h4>
          <p className="text-xs text-white/60 font-light">{BUSINESS_INFO.hours}</p>
        </div>

        <div>
          <h4 className="text-sm font-bold uppercase tracking-widest text-brand-gold mb-6">Newsletter Gourmet</h4>
          ...
          <div className="flex flex-col space-y-2">
            <input
              ...
              className="bg-white/5 border border-white/10 rounded-none px-4 py-2 text-xs focus:outline-none focus:border-brand-gold"
            />
            <button className="bg-brand-gold text-brand-dark py-2 text-xs font-bold uppercase tracking-widest hover:bg-brand-gold/90 transition-colors">
              Suscribirse
            </button>
          </div>
        </div>
